...
<header>
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target=".navbar-collapse" aria-controls="navBar" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navBar">
            <ul class="navbar-nav me-auto">
                <li class="nav-item" >
                    <a class="<?php if ($_SERVER['REQUEST_URI'] == "/?c=home") { ?>nav-link active<?php } else { ?>nav-link<?php } ?>" href="<?= $link->url("home.index") ?>">Home</a>
                </li>
                <li class="nav-item" >
                    <a class="<?php if ($_SERVER['REQUEST_URI'] == "/?c=home&a=allPrints") { ?>nav-link active<?php } else { ?>nav-link<?php } ?>" href="<?= $link->url("home.allPrints") ?>">All prints</a>
                </li>
                <li class="nav-item">
                    <a class="<?php if ($_SERVER['REQUEST_URI'] == "/?c=home&a=customPrint") { ?>nav-link active<?php } else { ?>nav-link<?php } ?>" href="<?= $link->url("home.customPrint") ?>">custom print</a>
                </li>
                <li class="nav-item">
                    <a class="<?php if ($_SERVER['REQUEST_URI'] == "/?c=home&a=about") { ?>nav-link active<?php } else { ?>nav-link<?php } ?>" href="<?= $link->url("home.about") ?>">About</a>
                </li>
            </ul>
